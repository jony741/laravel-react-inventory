...
import {
    ...
    Building2, Package, Receipt, CheckCircle, AlertCircle, Loader2
} from 'lucide-react';
...
export function PurchaseOrderForm({
    ...
    const [currentOrderStatus, setCurrentOrderStatus] = useState<OrderStatus>('NEW');
                    ...
                    <Form
                        ...
                        onSuccess={() => {
                            if (currentOrderStatus === 'NEW') {
                                // Refresh the page to get the new order
                                router.reload({
                                    preserveScroll: true,
                                    onSuccess: () => {
                            ...
                            <>
                                ...
                                <div
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {currentOrderStatus === 'DRAFT' && (
                                            <Button type="button" size="sm" onClick={handleApproveClick}
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                            ...
                                            <div className="rounded-xl border bg-card p-5 space-y-4">
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <span
                                                            className="text-muted-foreground flex items-center gap-1">Tax</span>
                                                        <Input
                                                            type="number"
                                                            value={tax}
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <span
                                                            className="text-muted-foreground flex items-center gap-1">Shipping</span>
                                                        <Input
                                                            type="number"
                                                            value={shippingCost}
